...
def _safe_attachment_basename(filename: str) -> str:
    ...
    """
    # Extension preservation: extract the last dot-segment if present
    # and short (≤8 chars). Anything longer probably isn't a real
    # extension and gets folded into the base.
    ...
    # Final cap: bound any single component at 80 chars (pre-cap base
    # to leave room for a maybe-truncated extension).
