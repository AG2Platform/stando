...
Ported verbatim from OSS sutando in Phase 5.10 of the OSS->private sync.
Stando previously carried the resolution chain inline in both consumer
files; this helper extract unifies them via the same pattern used by
`send_allowlist.py` in Phase 5.9.
"""
