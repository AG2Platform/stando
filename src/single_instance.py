...
Ported verbatim from OSS sutando in Phase 5.5 of the OSS→private sync.
Stando bridges (telegram, discord, slack) all resolve via the same
`workspace_default.resolve_workspace()` helper, so no adaptation is needed.
"""
